...
function SinglePost(props) {
  ...
  const singleData =
    data && data.state === "hasValue" && data.contents ? data.contents : {};
        ...
        <div className={`${loading ? "hiding" : "showing"} theBody`}>
          ...
          <div className="row ml-3 mb-4">
            <div className="col-sm-2">
              <a
                href={`https://twitter.com/intent/tweet?url=https://wayachat-preview.netlify.app/blog/${postId}`}
              >
                <img
                  src="/twitter.png"
                  style={{ maxWidth: "20%" }}
            ...
            <div className="col-sm-2">
              <a
                href={`https://www.facebook.com/sharer/sharer.php?u=https://wayachat-preview.netlify.app/blog/${postId}`}
              >
                <img
                  src="/facebook.png"
                  style={{ maxWidth: "10%" }}
