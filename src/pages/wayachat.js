...
function WayaChat() {
  ...
  const { cat } = useParams();
  const categoryData =
    categories.find((category) => category.url === cat) || {};
  const gridData =
    categoryData &&
    products.filter(
      (product) => product.product_category_id === categoryData.id
    );
  ...
  const features = [
    {
      ...
      description:
        "Get enacted and execute inside 2 minutes. Totally internet onboarding with least documentation.",
    },
    {
      img: "/posfeat/2.png",
      title: "Easy Integration",
      description:
        "With modules for every significant stage and dialects, coordinate and go live with wayaPay in under 60 minutes.",
    },
    {
      img: "/posfeat/3.png",
      title: "API Driven",
      description:
        "Assemble your business for scale with our total API-driven robotization that requires zero manual intercession.",
    },
    {
      img: "/posfeat/4.png",
      title: "Multiple payment methods",
      description:
        "Offer your customer the luxury of payment method that waya pay supports including credit/debit cards, USSD, Bank and wallets",
    },
    {
      img: "/posfeat/5.png",
      title: "Simple Pricing",
      description:
        "Our imaginative installment arrangements with serious evaluating simplify installments.",
    },
    {
      img: "/posfeat/6.png",
      title: "Best in Industry Support",
      description:
        "Continuously accessible email, telephone and talk based help to help you in all your means.",
    },
    {
      img: "/posfeat/7.png",
      title: "Dashboard Reporting",
      description:
        "Continuous information and bits of knowledge on your Wayapay Dashboard to settle on informed business choices.",
    },
    {
      img: "/posfeat/8.png",
      title: "Secure",
      description:
        "PCI DSS Level 1 consistent arrangement which eliminates your weight of administrative consistence.",
    },
  ];
          ...
          <Fade right>
            <div className="pb-1 row justify-content-center">
                ...
                {cat === "waya-pos" ? (
                  <Fade left>
                    <div className="py-lg-5">
                      <a className="btn btn-lg btn-orange px-3">
                        REGISTER NOW{" "}
                        <img className="mx-2" alt="..." src="/arrRight.png" />
                      </a>
              ...
              <div className="col-md-4">
                <img
                  src={`${imageUrl}${categoryData.category_image_url}`}
                  alt="Socialize Jumbotron"
                />
              </div>
            </div>
          </Fade>
                    ...
                    <div className="px-lg-5">
                      ...
                      <p className="m-0">
                        <img
                          ...
                          className="me-3"
                        />{" "}
                        Start collecting real-life payment from your customers
                        either by integrating with our platforms or using our
              ...
              <div className="container">
                <Fade top>
                  <div className="text-center px-lg-5 mb-5">
                    ...
                    <p className="lh-sm">
                      Enable your business with the appropriate tools to
                      acknowledge online <br /> payments and give the best
                      client experience
                    </p>
                  </div>
                </Fade>
                  ...
                  <Fade right>
                    <div className="col-md-6 py-5">
                      <div className="px-lg-5">
                        ...
                        <span>Account is secured by</span>
                        <br />
