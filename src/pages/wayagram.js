...
function WayaGram() {
  const [longText, setLongText] = useState(
    "Connect with friends, share what you’re uo to, or see what’s new from others all over the world. Explore our community where you can feel free to be yourself and share everything from your daily moments to life’s hignlights."
  );
  ...
  return (
    <div>
      <TopNav />
      <div
        className="jumbotron wayagramJumbotron py-4 mb-0"
