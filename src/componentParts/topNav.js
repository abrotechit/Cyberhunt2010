    ...
    <nav className="navbar navbar-expand-lg" style={{ backgroundImage: 'url(/grain.png)' }}>
      ...
      <div className="collapse navbar-collapse justify-content-center" id="navbarNavDropdown">
        <ul className="navbar-nav mr-4">
          ...
          <li className="nav-item active">
            <Link className="nav-link" to="/wayagram">Our SOlutions</Link>
          </li>
          <li className="nav-item active">
            <Link className="nav-link" to="/contact">Contact Us</Link>
          </li>
          <li className={`${location.pathname == '/signin' ? 'hiding' : 'showing'} nav-item d-md-none d-xl-none d-xxl-none d-sm-flex`}>
            <abbr className="nav-link" href={process.env.REACT_APP_LOGIN_URL}>LOGIN</abbr>
          </li>
          <li className={`nav-item link-btn d-md-none d-xl-none d-xxl-none d-sm-flex`}>
            <a className="nav-link" href={process.env.REACT_APP_REGISTER_URL}>REGISTER</a>
          </li>
        </ul>
      </div>
      <ul className="navbar-nav mr-4 d-none d-sm-none d-md-none d-lg-flex">
        <li className={`${location.pathname == '/signin' ? 'hiding' : 'showing'} nav-item`}>
          <a className="nav-link" href={process.env.REACT_APP_LOGIN_URL}>LOGIN</a>
        </li>
