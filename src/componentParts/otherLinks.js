      ...
      <div className='sub-footer'>
        ...
        <div className='bottom-subfooter'>
          <div className='bsf-item'>
            ...
            <div
              className='bsfi-foot'
              onClick={() => window.open(process.env.REACT_APP_WAYABANK_URL, '_blank')}
            >
              Explore Wayabank
            </div>
          </div>
          <div className='bsf-item'>
            ...
            <div
              className='bsfi-foot'
              onClick={() => window.open(process.env.REACT_APP_WAYAPAY_URL, '_blank')}
            >
              Explore WayaPay
            </div>
          </div>
          <div className='bsf-item'>
            <img src="/wayapos.svg" />
            <div className='bsfi-cont'>
              Accepts MasterCard, VISA and Verve cards payment and perform other mobile banking services at your physical store with Wayapos Terminal POS device.
            </div>
            <div
              className='bsfi-foot'
              onClick={() => window.open(process.env.REACT_APP_WAYAPOS_URL, '_blank')}
            >
              Explore WayaPos
            </div>
          </div>
