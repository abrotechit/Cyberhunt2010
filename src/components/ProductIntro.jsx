        ...
        <div className="flex flex-col py-8 px-8 md:px-0">
            <div className="w-full h-auto md:h-auto grid grid-cols-1 md:grid-cols-2 md:pb-16">
                ...
                <div className="w-full md:w-4/5 pr-10 flex flex-col items-start justify-center ...">
                    <h4 data-aos="fade-up" className="title md:text-xl md:mt-12 font-semibold">Get onboarded and begin accepting payments in no time.</h4>
                    <ul className="mt-8">
                        <li data-aos="fade-up" data-aos-delay="300" className="flex items-center gap-3 my-6">
                            ...
                            <p className="w-4/5 ..."><span className="text-primary-theme">Register</span> account with us.</p>
                        </li>
                        <li data-aos="fade-up" data-aos-delay="400" className="flex items-center gap-3 my-6">
                            <svg width="35" height="33" viewBox="0 0 35 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="35" height="33" rx="10" fill="#FFECE6" />
                                <path d="M25 11L14 22L9 17" stroke="#FF4400" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                            <p className="w-4/5 ...">Perform test mode transactions by using test API keys.</p>
                        </li>
                        <li data-aos="fade-up" data-aos-delay="500" className="flex items-center gap-3 my-6">
                            <svg width="35" height="33" viewBox="0 0 35 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="35" height="33" rx="10" fill="#FFECE6" />
                                <path d="M25 11L14 22L9 17" stroke="#FF4400" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        ...
                        <li data-aos="fade-up" data-aos-delay="600" className="flex gap-3 my-6">
                            <svg width="35" height="33" viewBox="0 0 35 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="35" height="33" rx="10" fill="#FFECE6" />
                                <path d="M25 11L14 22L9 17" stroke="#FF4400" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
            ...
            <div className="flex flex-col items-center mt-20 md:mt-0">
                <h4 data-aos="fade-up" data-aos-delay="300" className="title2 md:mt-12 text-primary-theme text-4xl font-semibold">Wayapay Prducts</h4>

                <div data-aos="fade-up" data-aos-delay="300" className="toggle mt-6 border border-gray-100 flex items-center w-full md:w-2/5 h-14 rounded-full bg-gray-100 relative ...">
                    ...
                    <p className="text-gray-500 pl-6 text-md md:text-md font-medium">Terminal POS</p>
                </div>
            </div>
        </div>
    )
