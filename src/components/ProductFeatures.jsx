...
function ProductFeatures() {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 pl-20 pr-0 md:px-32 py-24 relative">
            <svg width="22" height="418" className="absolute left-8 md:left-20 top-28" viewBox="0 0 22 418" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <line x1="10.5" y1="21" x2="10.5" y2="198" stroke="black" stroke-opacity="0.3" />
                <line x1="11.5" y1="220" x2="11.5" y2="396" stroke="black" stroke-opacity="0.3" />
            </svg>
            ...
            <div className="flex items-center">
                <img data-aos="fade-up" data-aos-delay="700" src={Privacy} alt="" className="md:-mt-12 w-4/5 md:w-full ..." />
            </div>
        </div>
    )
}
